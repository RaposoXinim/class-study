...
class BancoDeDados:
    ...
    def atualizar_veiculo(self, veiculo):
        if self.conn:
            try:
                ...
                print(f"Falha ao atualizar o veiculo: {e}")
    ...
    def buscar_todas_pessoas(self):
        ...
        if self.conn:
            ...
            except sqlite3.Error as e: print(f"Erro ao buscar pessoa: {e}")
        return pessoas
    def buscar_todos_veiculos(self):
        ...
        if self.conn:
            ...
            except sqlite3.Error as e: print(f"Erro ao buscar veiculo: {e}")
        return veiculos
